...
class TxnMallTest(ColomboTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 CLM:
        ...
        # First: use raw transaction API to send 1240 CLM to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 CLM coin each
        ...
        # Node0's balance should be starting balance, plus 50CLM for another
        ...
        # Node0's total balance should be starting balance, plus 100CLM for 
