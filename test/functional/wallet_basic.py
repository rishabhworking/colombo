...
class WalletTest(ColomboTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 CLM from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 CLM with subtract fee from amount
        ...
        # Sendmany 10 CLM with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: http://github.com/colombiacoin/colombo/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
