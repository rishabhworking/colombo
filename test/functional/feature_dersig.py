...
class BIP66Test(ColomboTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # colombod is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and colombod produces more specific reject
            # reasons.
