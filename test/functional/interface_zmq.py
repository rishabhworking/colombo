...
from test_framework.test_framework import ColomboTestFramework, SkipTest
...
class ZMQTest (ColomboTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that colombo has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("colombod has not been built with zmq enabled.")
