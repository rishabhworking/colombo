...
# TestNode: A peer we use to send messages to colombod, and store responses.
...
class CompactBlocksTest(ColomboTestFramework):
    ...
    # This test actually causes colombod to (reasonably!) disconnect us, so do this last.
    ...
    # Test that colombod requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for colombod to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # colombod will not send blocktxn responses for blocks whose height is
