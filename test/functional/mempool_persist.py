...
By default, colombod will dump mempool on shutdown and
...
class MempoolPersistTest(ColomboTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give colombod a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent colombod from writing mempool.dat to disk. Verify that `savemempool` fails")
