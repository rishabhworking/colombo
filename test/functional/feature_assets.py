...
class AssetTest(ColomboTestFramework):
    ...
    def activate_assets(self):
        self.log.info("Generating CLM for node[0] and activating assets...")
    ...
    def big_test(self):
        ...
        n0.listassets(asset="CLM*", verbose=False, count=2, start=-2)
        ...
        colombo_assets = n0.listassets(asset="CLM*", verbose=False, count=2, start=-2)
        assert_equal(len(colombo_assets), 2)
        assert_equal(colombo_assets[0], "CLM2")
        assert_equal(colombo_assets[1], "CLM3")
        self.sync_all()
