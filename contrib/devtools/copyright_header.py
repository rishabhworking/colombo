...
EXPECTED_HOLDER_NAMES = [
    ...
    "The Colombo Core developers\n",
    "The Colombo Core developers \n",
    "Colombo Core Developers\n",
    "the Colombo Core developers\n",
    "The Colombo developers\n",
    "BitPay Inc\.\n",
    "BitPay, Inc\.\n",
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Colombo Core developers'
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Colombo 
