...
find ${DISTNAME}/bin -type f -executable -exec ../colombo/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../colombo/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/colombo/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/colombo/depends/SDKs/MacOSX10.11.sdk.tar.gz
