...
#ifndef CLM_VALIDATION_H
#define CLM_VALIDATION_H
...
/** Block download timeout base, expressed in millionths of the block interval (i.e. 10 min) */ // TODO Should we change this for colombo, with 1 minutes block intervals?
