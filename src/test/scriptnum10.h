...
#ifndef CLM_TEST_SCRIPTNUM10_H
#define CLM_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Colombo Core 0.10.0, for cross-comparison.
 */
public:
