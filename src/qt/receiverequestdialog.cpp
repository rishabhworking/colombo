...
#include "config/colombo-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatColomboURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + ColomboUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatColomboURI(info));
}
