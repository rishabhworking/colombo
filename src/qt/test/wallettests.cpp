...
#include "qt/colomboamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<ColomboAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_colombo-qt -platform xcb      # Linux
//     src/qt/test/test_colombo-qt -platform windows  # Windows
//     src/qt/test/test_colombo-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = ColomboUnits::formatWithUnit(unit, balance, false, ColomboUnits::separatorAlways);
    ...
    // Amount input
    ColomboAmountField* amountInput = receiveCoinsDialog.findChild<ColomboAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: colombo:")) != -1);
