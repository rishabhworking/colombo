...
#ifndef CLM_QT_CLMGUI_H
#define CLM_QT_CLMGUI_H
...
/**
  Colombo GUI main class. This class represents the main window of the Colombo UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class ColomboGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit ColomboGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~ColomboGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a colombo wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
