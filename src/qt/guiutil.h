...
#ifndef CLM_QT_GUIUTIL_H
#define CLM_QT_GUIUTIL_H
...
/** Utility functions used by the Colombo Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "colombo:" URI into recipient object, return true on successful parsing
