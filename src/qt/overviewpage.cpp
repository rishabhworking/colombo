...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(ColomboUnits::CLM),
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(ColomboUnits::formatWithUnit(unit, balance, false, ColomboUnits::separatorAlways));
    ui->labelUnconfirmed->setText(ColomboUnits::formatWithUnit(unit, unconfirmedBalance, false, ColomboUnits::separatorAlways));
    ui->labelImmature->setText(ColomboUnits::formatWithUnit(unit, immatureBalance, false, ColomboUnits::separatorAlways));
    ui->labelTotal->setText(ColomboUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, ColomboUnits::separatorAlways));
    ui->labelWatchAvailable->setText(ColomboUnits::formatWithUnit(unit, watchOnlyBalance, false, ColomboUnits::separatorAlways));
    ui->labelWatchPending->setText(ColomboUnits::formatWithUnit(unit, watchUnconfBalance, false, ColomboUnits::separatorAlways));
    ui->labelWatchImmature->setText(ColomboUnits::formatWithUnit(unit, watchImmatureBalance, false, ColomboUnits::separatorAlways));
    ui->labelWatchTotal->setText(ColomboUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, ColomboUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("CLM")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the CLM balance grid from expanding and looking terrible when asset balance is hidden
