...
#ifndef CLM_QT_CLMUNITS_H
#define CLM_QT_CLMUNITS_H
...
/** Colombo unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ColomboUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ColomboUnits(QObject *parent);

    /** Colombo units.
      @note Source: https://en.colombo.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        CLM,
...
typedef ColomboUnits::Unit ColomboUnit;

#endif // CLM_QT_CLMUNITS_H
