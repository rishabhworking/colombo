Colombo Core version *2.2.2* is now available!!
==============

  <http://github.com/colombiacoin/colombo/releases/tag/v2.2.2>
...
- Enhancements for Colombo Dev Kit and Mobile Wallet Support
...
Changelog available here: <http://github.com/colombiacoin/colombo/commits/release_2.2.2>
