Colombo Core version *2.0.4.0* is now available!!
==============

  <http://github.com/colombiacoin/colombo/releases/tag/v2.0.4>
...
Changelog available here: <http://github.com/colombiacoin/colombo/commits/release_2.0.4>
