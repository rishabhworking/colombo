Colombo Core version *2.1.0* is now available!!
==============

  <http://github.com/colombiacoin/colombo/releases/tag/v2.1.0>
...
Changelog available here: <http://github.com/colombiacoin/colombo/commits/release_2.1.0>
