...
This document provides guidelines for internationalization of the Colombo Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `colombo_en.ts` remains unchanged.
